...
Builder.registerComponent(FaqAccordion, {
  name: "FaqAccordion",
  inputs: [
    { name: "heading", type: "string", defaultValue: "Frequently Asked Questions" },
    {
      name: "intro",
      type: "longText",
      defaultValue: "Chances are, if you're wondering about it, someone else has too. Here are answers to some of the questions we hear most often.",
    },
    {
      name: "items",
      type: "list",
      defaultValue: [
        {
          ...
          answer: "The fastest value boosts usually come from low-cost, high-visibility fixes like fresh paint, updated landscaping, and organized storage. Larger projects like kitchen or bathroom remodels can pay off too, but they take more time and money to complete.",
        },
        {
          question: "What happens if my escrow account has a shortage?",
          answer: "Yes, deferred maintenance is one of the most common reasons buyers negotiate down an offer or walk away entirely. Staying current on tasks like HVAC servicing, roof inspections, and gutter cleaning helps protect the value you've already built.",
        },
        {
          question: "How often should I check on my home's value and condition?",
          answer: "Most homeowners benefit from a quick review once or twice a year, and again before any major life change like refinancing or selling. A short walkthrough of your home's systems, insurance coverage, and equity position can catch small issues before they become expensive ones.",
        },
        {
          question: "Does my homeowners insurance need to change as my home's value goes up?",
          answer: "Homeowners insurance should be reviewed regularly because coverage limits set at purchase don't automatically keep up with rising home values or rebuilding costs. An outdated policy can leave you underinsured even if your home has gained significant value.",
        },
        {
          question: "Can increasing my home's value help me access more equity?",
          answer: "Yes, home improvements and market appreciation can both increase the equity available to you through a cash-out refinance or home equity option. Talking with a mortgage banker about your updated home value is the best way to know what options you currently qualify for.",
        },
      ],
      subFields: [
